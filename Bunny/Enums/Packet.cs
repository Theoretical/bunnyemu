...
namespace Bunny.Enums
{
    ...
    public enum Results : int
    {
        ...
        ClanCannotBeCreated = 30030,
        ClanUserAlreadyInAClan = 30034,
        ClanNameInUse = 30032,
        ClanNotAuthorized = 30038,
        ClanJoinRejected = 30040,
        FriendNotOnline = 30046,
    ...
    public enum Operation : ushort
    {
        ...
        ChannelRequestAllPlayerList = 0x4D0,
        ChannelResponseAllPlayerList = 0x4D1,
        ...
        AgentLocateToClient = 0x13C5,
        AgentPeerReady = 0x13C7,
        AgentPeerUnbind = 0x13D1,
        AgentStageRelease = 0x13BC,
        QuestNpcSpawn = 0x1770,
        AdminAnnounce = 0x1F5,
        AdminRequestBan = 0x203,
        AdminResponseBan = 0x204,
        AdminHide = 0x213,
        AdminAssassin = 0x21,
        LadderPrepare = 0x62A,
        LadderLaunch = 0x62B,
